...
def handle_follow(event):
    ...
    text_message3 = TextSendMessage(
        text="台北市這幾年開啟了無圍牆博物館計畫，「城市是一座沒有邊界的博物館，你，身處其中，聽，臺北的聲音，故事，就在你身邊流動。」 \n https://ecomuseums.gov.taipei/Default.aspx")
    ...
    line_bot_api.reply_message(event.reply_token, [
                               text_message1, text_message2, text_message3, image_message])
# --------------------------------自動發送歡迎訊息--------------------------------
        ...
        message1 = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://i.imgur.com/zzuL4ha.jpg',
                        title='景點故事3',
                        text='點擊查看 "公廁" 的故事！',
                        actions=[
                            PostbackAction(
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://i.imgur.com/3452TMO.jpg',
                        title='景點故事5',
                        text='點擊查看 "農事所宿舍2" 的故事！',
                        actions=[
                            PostbackAction(
                                label='農試所宿舍2',
                                data='農試所2'
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://i.imgur.com/0NUZxSG.jpg',
                        title='景點故事6',
                        text='點擊查看 "夫妻樹" 的故事！',
                        actions=[
                            PostbackAction(
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://7.share.photo.xuite.net/mhps22/172d95d/19794561/1118706396_m.jpg',
                        title='景點故事7',
                        text='點擊查看 "古道" 的故事！',
                        actions=[
                            PostbackAction(
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://i.imgur.com/men4pH1.jpg',
                        title='景點故事8',
                        text='點擊查看 "瑠公圳" 的故事！',
                        actions=[
                            PostbackAction(
...
def handle_message(event):
    ...
    if data == '護村神樹':
        text_message = TextSendMessage(
            text="兩棵老樹(正榕、雀榕) 於2013年被社區提報為市定老樹，成功阻擋將要拆除眷村的怪手，因此居民匿稱他們為護村神樹。2019年台科大為兩棵老樹打開樹穴，讓大樹爺爺可以好好的喘口氣啦！")
        image_message = ImageSendMessage(
        ...
        line_bot_api.reply_message(
            event.reply_token, [text_message1, text_message2, image_message])
    elif data == '公廁':
        text_message = TextSendMessage(
            text="可以稍微休息上個廁所囉~ 在早期眷村的沒有廁所，只能依賴它，現在為第四代公廁，以前僅有一半大，旁邊還有棵「金龜子樹」，可掛繩子玩盪鞦韆。在沒路燈的年代，夜晚黑壓壓一片，十分可怕！")
        image_message = ImageSendMessage(
        ...
        text_message = TextSendMessage(
            text="猜到了嗎？這是「水」字型的圍欄，它與以前社區旁的瑠公圳圍欄相同，目前仍有幾處被保存著。")
        image_message = ImageSendMessage(
        ...
        text_message = TextSendMessage(
            text="舊為農試所畜產系，中庭種植的兩棵小葉南洋杉一高一矮就好像一對夫妻，因此被暱稱為「夫妻樹」，幾年前因風災倒塌一棵，過了幾年又長出來了，他們就像夫妻一樣彼此分不開。\n建築拆除後成為社區的小公園，有公共藝術與夜間太陽能照明等。")
        image_message = ImageSendMessage(
        ...
        text_message = TextSendMessage(
            text="日治初期開關的「陸軍道」為軍隊運輸武器彈藥的路徑，在羅斯福路拓寬前曾短暫成為進出臺北盆地的主要道路。")
        image_message = ImageSendMessage(
    ...
    if data == '關於蟾蜍山':
        ...
        text_message = TextSendMessage(
            text="傳說500年前某一天，劉海仙翁雲遊到景美一帶，遙望北方山巔妖氣沖天，發現一隻蟾蜍精盤據隘口、危害人畜，仙翁決心收妖，便用一串金錢幣引誘怪物上鉤，一不小心用力過猛，雙腳陷入石內。怪物收伏後，仙翁大笑離去，留下一對足跡供後人瞻仰（景美仙跡岩），而北方山巔則稱為「蟾蜍山」。")
        line_bot_api.reply_message(event.reply_token, text_message)
    elif data == '劉海仙翁':
        text_message = TextSendMessage(
            text="道教全真派全真五祖之一的劉海蟾喜歡將頭髮梳至額前，長度齊眉，故稱此種頭髮為「劉海」，後為了區別，改稱「瀏海」。")
        image_message = ImageSendMessage(
    ...
    if data == '咖啡廳菜單內容':
        ...
        line_bot_api.reply_message(
            event.reply_token, [text_message1, text_message2])
   ...
   # 景點故事recall
    if data == '再看景點故事':
        ...
        line_bot_api.reply_message(event.reply_token, [image_message,message1])

    # 折價挑戰
    if data == '折價挑戰':
        text_message0 = TextSendMessage(
            text="現在開始折價挑戰問答啦! 如果忘記了故事的話可以點擊選單再看一次景點故事噢!")
        ...
        text_message0 = TextSendMessage(
            text="太棒了! 恭喜你完成了折價挑戰，將這則訊息向咖啡廳櫃台人員展示即可享有折扣!")
        image_message = ImageSendMessage(
        ...
        text_message1 = TextSendMessage(
            text="獲得折扣後千萬別急著走，可以再多使用我們的其他功能來探索蟾蜍山呦~!")
        line_bot_api.reply_message(
            event.reply_token, [text_message0, image_message, text_message1])

    elif data == '1_A' or data == '1_B':
        text_message0 = TextSendMessage(
            text="答錯了...沒關係 ! 再挑戰一次 ! 可以再看一次故事確認答案喔~")
        text_message1 = TextSendMessage(
            text="兩棵老樹(正榕、雀榕) 於2013年被社區提報為市定老樹，成功阻擋將要拆除眷村的怪手，因此居民匿稱他們為護村神樹。2019年台科大為兩棵老樹打開樹穴，讓大樹爺爺可以好好的喘口氣啦！")
        image_message = ImageSendMessage(
            original_content_url='https://i.imgur.com/Q2aTjmP.jpg',
        ...
        msg = sent_gametemp('msg1')
        line_bot_api.reply_message(
            event.reply_token, [text_message0, text_message1, image_message] + msg)
        ...
        msg = sent_gametemp('msg2')
        line_bot_api.reply_message(
            event.reply_token, [text_message0, text_message1, text_message2] + msg)
